...
**Banda de cabecera — 4 alturas distintas** en 8 plantillas con banda.

| Alto | Rutas |
| ---: | --- |
| 630 px | `/asesor-virtual`, `/productos/microfibra/dortmund-plus` |
...
**Fin del `<h1>` — 10 posiciones distintas.**
...
✅ Ningún enlace interno roto y ningún ancla sin destino.
...
| `src/components/ui/Navbar.tsx:535` | `text-[24px]` | sin equivalente exacto |
...
| excepción aprobada al guardarraíl de tokens | `src/components/ui/Navbar.tsx:534` | `{/* eslint-disable-next-line no-restricted-syntax -- tamaño de glifo "+" del acordeón, no es texto (fase 3) */}` |
| excepción aprobada al guardarraíl de tokens | `src/components/ui/ProductCard.tsx:80` | `{/* eslint-disable-next-line no-restricted-syntax -- título de card fluido: escala propia del componente, no editorial (` |
| excepción aprobada al guardarraíl de tokens | `src/components/ui/SubcategoryTile.tsx:132` | `{/* eslint-disable-next-line no-restricted-syntax -- título de card fluido: escala propia del componente, no editorial (` |
